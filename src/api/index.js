...
/* Snowflake comparators + tmp-id helpers — ids are STRINGS (never Number
   them); screens doing unread dividers / gap sync order with these instead of
   numeric compares. Exported here so components never deep-import a module. */
export { mid, cmpId, gteId, gtId, maxId, newTmpId, isTmpId } from './ids.js'
